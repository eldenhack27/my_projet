...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $sql = "INSERT INTO seance (matricul, date, heure, periode, filiere, niveau, matiere, professeur) VALUES (:matricul, :date, :heure, :periode, :filiere, :niveau, :matiere, :professeur)";
