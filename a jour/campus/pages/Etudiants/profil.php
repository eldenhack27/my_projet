  ...
  <div class="modal-content">
    ...
    <input type="hidden" name="matricule" value="<?php echo htmlspecialchars($etudiant['matricule']); ?>">
              ...
              <div class="input__wrapper">
                  ...
                  <input type="email" id="email" name="email" class="input__field" value="<?php echo htmlspecialchars($etudiant['email']); ?>" placeholder="email etudiant" required autocomplete="off">  
              </div>
              <div class="input__wrapper">
...
<a href="etudiant.php" style="position: fixed; margin-left: 1rem; color: white; margin-top: 1rem;">
