...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $sql = "UPDATE etudiant SET Nom = :nom, Prenom = :prenom, dateofbirth = :dateofbirth, telephone = :telephone, email = :email, filiere = :filiere, niveau = :niveau, profil = :profil WHERE matricule = :matricule";
