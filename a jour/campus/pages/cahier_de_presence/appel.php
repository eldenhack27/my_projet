...
<body>
    ...
    <main>
    <a href="cahier_de_presence.php" style="position: fixed;">
    ...
    <div class="container">
       ...
       <div class="filters">
        ...
        <input type="hidden" id="cahier_professeur" value="<?php echo htmlspecialchars($cahier['professeur']); ?> <?php echo htmlspecialchars($cahier['prenom']); ?>">
