...
<body>
    <form class="my-form" method="post" action="login_en.php">
        <div class="login-welcome-row">
            <a href="#" title="Logo">
                <img src="../../assets/images/imelogos.png" alt="Logo" class="logo">
            </a>
            <h1>&#x1F393; IME - School &#127891;</h1>
            <p class="p">Se connecter en tant qu'enseignant</p>
        </div>
        <div class="input__wrapper">
            <input type="matricul" id="matricul" name="matricul" class="input__field" placeholder="Your Email" required autocomplete="off">
            <label for="matricul" class="input__label">Matricule :</label>
