...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($user && password_verify($mot_de_passe, $user['mot_de_passe'])) {
            ...
            $_SESSION['user_dateofbirth'] = $user['dateofbirth']; 
            $_SESSION['user_telephone'] = $user['telephone']; 
            $_SESSION['user_email'] = $user['email'];
            $_SESSION['user_mot_de_passe'] = $user['mot_de_passe']; 
            $_SESSION['user_acreditation'] = $user['acreditation'];
            $_SESSION['user_profil'] = $user['profil']; // Assurez-vous que la colonne 'nom' existe dans votre table 'users'
